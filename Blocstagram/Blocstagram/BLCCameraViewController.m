...
- (void) cameraButtonPressedOnToolbar:(BLCCameraToolbar *)toolbar {
    ...
    [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler: ^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
        if (imageSampleBuffer) {
            ...
            image = [image imageByScalingToSize:self.captureVideoPreviewLayer.bounds.size andCroppingWithRect:self.captureVideoPreviewLayer.bounds];
            ...
            image = [image imageByScalingToSize:image.size andCroppingWithRect:cropRect];

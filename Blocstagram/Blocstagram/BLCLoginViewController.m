...
//  Blocstagram
//
//  Created by Trevor Vieweg on 5/26/15.
...
- (void) loadView {
    ...
    self.view = webView;
    self.title = @"Login";
    UIBarButtonItem *homeButton = [[UIBarButtonItem alloc] initWithTitle:@"Home" style:UIBarButtonItemStylePlain target:self action:@selector(viewDidLoad)];
